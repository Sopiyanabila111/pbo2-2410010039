...
public class Perpustakaan {
    ...
    /**
     * Mencari koleksi yang judulnya memuat kataKunci, tanpa membedakan huruf besar dan kecil.
     */
    ...
    public long kembalikan(String kode, int hariTerlambat) {
        ...
        // Polymorphism: rumus denda mengikuti jenis object (Buku, Majalah, atau Skripsi)
