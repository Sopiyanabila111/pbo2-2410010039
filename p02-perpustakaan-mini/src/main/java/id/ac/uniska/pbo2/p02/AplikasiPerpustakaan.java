 ...
 * termasuk pengujian koleksi Skripsi dan pencarian judul.
 */
public class AplikasiPerpustakaan {
    ...
    public static void main(String[] args) {
        ...
        perpus.tambah(new Skripsi("S001", "Analisis Performa Algoritma Sorting",
                2026, "Ahmad Fadli", "Teknik Informatika"));
        ...
        // Pengujian fitur baru: pencarian judul dan peminjaman Skripsi
